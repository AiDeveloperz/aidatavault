...
export const metadata: Metadata = {
  ...
  description: 'Search leaked data for security research purposes. Powered by advanced breach intelligence databases.',
  keywords: ['osint', 'breach intelligence', 'security research', 'data lookup'],
